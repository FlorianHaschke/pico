...
<path id="Rectangle 1" d="M222 119V158C222 172.142 222 179.213 226.393 183.607C230.787 188 237.858 188 252 188H289" stroke="url(#paint0_linear_118_173)" stroke-width="3" fill="none"/>
<path id="Rectangle 2" d="M144 188H178C192.142 188 199.213 188 203.607 183.607C208 179.213 208 172.142 208 158V119" stroke="url(#paint1_linear_118_173)" stroke-width="3" fill="none"/>
<text fill="#2906FA" x="68" y="198" font-size="19px" font-family="Julius Sans One">CHARGING_POWER_PLACEHOLDER W</text> 
...
<stop offset="1" stop-color="#33A716"/>
      ...
      >
        ...
        response = 'HTTP/1.0 200 OK\r\n\r\n{}'.format(html_content.replace('CHARGING_POWER_PLACEHOLDER', str(round(chargingPower, 1))))
